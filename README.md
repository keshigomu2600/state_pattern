...
# ビルド状態
[![MSBuild](https://github.com/keshigomu2600/state_pattern/actions/workflows/msbuild.yml/badge.svg)](https://github.com/keshigomu2600/state_pattern/actions/workflows/msbuild.yml)
...
疑問に思った点
・main関数はループを使って廻したほうがいいのか、それともまた別の機能があるのかどうか疑問に思った
